...
def yolo_mobilev1(input_shape: list, anchor_num: int, class_num: int, **kwargs) -> [keras.Model, keras.Model]:
    ...
    if input_shape[0]==240:
        x1 = keras.layers.ZeroPadding2D(padding=((0, 1), (0, 0)))(x1)
    ...
    if input_shape[0]==224 and input_shape[1] ==320:
        y1_reshape = Reshape((7, 10, anchor_num, 5 + class_num), name='l1')(y1)
        y2_reshape = Reshape((14, 20, anchor_num, 5 + class_num), name='l2')(y2)
    elif input_shape[0] == 240 and input_shape[1] == 320:
        y1_reshape = Reshape((8, 10, anchor_num, 5 + class_num), name='l1')(y1)
        y2_reshape = Reshape((16, 20, anchor_num, 5 + class_num), name='l2')(y2)
