...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_size', type=int, help='net work output image size', default=(8, 10, 16, 20), nargs='+')
    ...
    parser.add_argument('--pre_ckpt', type=str,default="log/20220115-140711/yolo_model.h5", help='pre-train weights path')
